...
- [ ] `prefers-reduced-motion` respected for any layout transitions
...
- Use token values from C1-A for breakpoint references in comments
...
- **Size:** M
- **Tier:** Sonnet
- **blocked_by:** none (C1-A tokens are additive, no hard dependency)
