...
def test_create_product_successful_submission(page: Page, demo_base_url: str):
    ...
    expect(page.locator("dd")).to_contain_text("Test Product")
    expect(page.locator("dd")).to_contain_text("A great product")
    expect(page.locator("dd")).to_contain_text("12.34")
    expect(page.locator("dd")).to_contain_text("True")
    expect(page.locator("dd")).to_contain_text("books")
